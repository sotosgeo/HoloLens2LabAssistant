...
public class MediaCapturer : MonoBehaviour
{
    ...
    public int height, width, fps = 30;
        ...
        if (!useManualSettings)
        {
            ...
            switch (mediaCaptureProfiles)
            {
                case MediaCaptureProfiles.HL2_2272x1278:
                    ...
                    height = 1278;
                    break;
                case MediaCaptureProfiles.HL2_1952x1100:
                    width = 1952;
                    height = 1100;
                    break;
                case MediaCaptureProfiles.HL2_1504x846:
                    width = 1504;
                    height = 846;
                    break;
            ...
            bool isHL1)
    {
        ...
        if (sourceInfo != null)
        {
            ...
            //Initialize a MediaCapture object to use media frame sources by setting the SourceGroup property
            //of the MediaCaptureInitializationSettings object to a MediaFrameSourceGroup returned by FindAllAsync 
            //and then calling MediaCapture.InitializeAsync. 
            ...
            //The key for each entry in the dictionary is the Id property of the MediaFrameSourceInfo associated with each frame source in the group.
